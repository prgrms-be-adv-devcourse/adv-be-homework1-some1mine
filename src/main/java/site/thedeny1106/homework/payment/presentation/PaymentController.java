package site.thedeny1106.homework.payment.presentation;
...
import site.thedeny1106.homework.payment.application.PaymentService;
...
import site.thedeny1106.homework.payment.presentation.dto.PaymentFailRequest;
import site.thedeny1106.homework.payment.presentation.dto.PaymentRequest;
...
public class PaymentController {
    ...
    @PostMapping("/fail")
    public ResponseEntity<PaymentFailInfo> fail(@RequestBody PaymentFailRequest request) {
